# ESP-IDF 运行 07_color_panel 示例指南
...
```bash
cd "C:\Users\oxpas\Documents\GitHub\esp32-p4-waveshare-7inch-amoled-bringup\ESP32-P4-WIFI6-Touch-LCD-7B-main\examples\ESP-IDF\07_color_panel"
```
